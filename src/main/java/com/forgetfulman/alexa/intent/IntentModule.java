...
public class IntentModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        // custom intents
        mapBinder.addBinding("TotalOrdersIntent").to(TotalOrdersIntentAction.class);
        mapBinder.addBinding("OrderDetailsIntent").to(OrderDetailsIntentAction.class);
        mapBinder.addBinding("TotalOrdersOnHoldIntent").to(TotalOrdersOnHoldIntentAction.class);
        mapBinder.addBinding("LatestOrderTimestampIntent").to(LatestOrderTimestampIntentAction.class);
    }
